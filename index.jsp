			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown">User <i class="icon-angle-down"></i></a>
		...
		<div class="carousel slide wet-asphalt">
			...
			<div class="carousel-inner">
				<div class="item active"
					style="background-image: url(images/slider/tech.gif)">
					<div class="container">
						<div class="row">
							<div class="col-sm-12">
				...
				<!--/.item-->
				<div class="item"
					style="background-image: url(images/slider/light.gif)">
					<div class="container">
						<div class="row">
							<div class="col-sm-12">
								<div class="carousel-content center centered">
									<h2 class="boxed animation animated-item-1">Developed by
										the students of CSE</h2>
									<br />
									<p class="boxed animation animated-item-2">Parvathi B Khodanpur</p>
									<p class="boxed animation animated-item-2">Chandana S Rao</p>
									<p class="boxed animation animated-item-2">Akanksha Anilkumar</p>
									<p class="boxed animation animated-item-2">Ajay B G</p>
								</div>
							</div>
						</div>
					</div>
