	...
	<section id="career" class="container">
		...
		<div class="row">
			...
			<%
				...
				int access = Integer.parseInt((String)request.getAttribute("access"));
				Map<String,String> details  = (Map<String,String>) request.getAttribute("keyvalue_map");
			%>
			...
			<h4>The cloud app has has decrypted the data using the parameters you have provided.</h4>
			<h4>Here are the result.</h4>
			<br/><br/>
			<div class='col-md-12'>
					<br/><br/>
				...
				<%
					if (access>=4) {
						%>
							<a href='privilegeData?type=delete&data_id=<%=data_id%>' class='btn btn-danger' ><span class='glyphicon glyphicon-trash'></span> Delete Data</a> <br/><br/>
						<%
					}
				%>
						...
						while (it.hasNext()) {
							...
							%>
								<tr>
									...
									readonly="readonly"
									<% }  %> 
									class='form-control' name='key' rows=4><%=key %></textarea>
									</td>
									<td>
									<textarea 
									<% if (access<=1) {%>
									readonly="readonly"
									<% } %>
									class='form-control' name='value' rows=4><%=val %></textarea>									
									</td>
								</tr>
							<%
						}
